...
module.exports = {
    start: (port) => {
        ...
        http = app.listen(port, () => {
            ...
            console.log('Run "npm run db" to ensure your mongodb database is running...');
            if(port === 3000) console.log('Create an ENV file like the guide says... If not this will not work.');
        });
    },
    stop: () => {
        if (!isRunning) return "Server is shut down";
